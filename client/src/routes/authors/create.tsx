...
import { createAuthorSchema, type CreateAuthorDto } from "@/features/authors/schemas.ts";
import { useCreateAuthor } from "@/features/authors/authorsApi.ts";

function CreateAuthorPage(): React.JSX.Element {
	...
	const onSubmit = (data: CreateAuthorDto): void => {
	...
	return (
		<div className="mx-auto max-w-2xl space-y-8 animate-in fade-in duration-500">
			<div>
				...
				<h1 className="text-3xl font-bold text-slate-900">Новий автор</h1>
				<p className="text-slate-500">Додайте нового автора до бібліотеки</p>
			</div>
			...
			<div className="rounded-2xl bg-white p-8 shadow-sm ring-1 ring-slate-900/5">
				<form className="space-y-5" onSubmit={handleSubmit(onSubmit)}>
					...
					<div className="flex gap-3 pt-4">
						...
						>
							{createMutation.isPending ? "Збереження..." : "Створити автора"}
						</button>
						<Link
							to="/authors"
